...
<!-- //for-mobile-apps -->
<!-- Custom Theme files -->
<link href="home_css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="home_css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="home_css/fasthover.css" rel="stylesheet" type="text/css" media="all" />
<link href="home_css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
<link href="home_css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<!-- js -->
<script src="home_js/jquery.min.js"></script>
<link rel="stylesheet" href="home_css/jquery.countdown.css" /> <!-- countdown --> 
<!-- //js -->  
<!-- web fonts --> 
...
<body>
	...
	<script type="text/javascript" src="home_js/bootstrap-3.1.1.min.js"></script>
	<!-- //for bootstrap working -->
	<!-- header modal -->
				...
				<div class="modal-body modal-body-sub">
					<div class="row">
						<div class="col-md-8 modal_body_left modal_body_left1" style="border-right: 1px dotted #C2C2C2;padding-right:3em;">
							...
							<script src="home_js/easyResponsiveTabs.js" type="text/javascript"></script>
							<script type="text/javascript">
		...
		<div class="container">
			<div class="col-md-5 wthree_banner_bottom_left">
				<div class="video-img">
					...
					<!-- pop-up-box -->     
					<script src="home_js/jquery.magnific-popup.js" type="text/javascript"></script>
					<!--//pop-up-box -->
	...
	<div class="banner-bottom1">
		<div class="agileinfo_banner_bottom1_grids">
			...
			<div class="col-md-5 agileinfo_banner_bottom1_grid_right">
				...
				<script src="home_js/jquery.countdown.js"></script>
				<script src="home_js/script.js"></script>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_left">
					...
					<div class="wmuSlider example1">
						...
						<script src="home_js/jquery.wmuSlider.js"></script> 
						<script>
							$('.example1').wmuSlider();         
						</script> 
				</div>
	...
	<div class="top-brands">
		<div class="container">
			...
			<script type="text/javascript" src="home_js/jquery.flexisel.js"></script>
		</div>
	</div>
	<!-- //top-brands --> 
	<!-- newsletter -->
	...
	<!-- //footer --> 
	<!-- cart-js -->
	<script src="home_js/minicart.js"></script>
	<script>
        w3ls.render();
