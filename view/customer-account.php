 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <p class="lead" style="text-align:center;" >Change your personal details or your password here.</p>
                        <p class="text-muted" style="text-align:center;" >Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>

                        <h3 style="text-align:center;">Change password</h3><?php if(isset($_SESSION['password_change_message'])){ echo '<span style="color:#4fbfa8;">' . $_SESSION['password_change_message'] . '</span><br>'; } ?>
                        <form action="../index.php?" method="post">
                        <input type="hidden" name="action" value="Change pasword">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="confirm_new_password" class="form-control" id="password_2">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
