                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="buttons">
                                          <a href="../index.php?action=Product details&key=<?php echo $product['product_key']; ?>&location=category-left" class="btn btn-default">View detail</a>  
                                        <a href="../index.php?action=Add to basket&key=<?php echo $product['product_key']; ?>&location=category-left" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
