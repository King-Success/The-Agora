        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="img/b1.jpg" alt="" class="img-responsive">
                        </div>
                        <!-- <div class="item">
                            <img class="img-responsive" src="img/banner7.jpg" alt="">
                        </div>
                        <div class="item">
            ...
            <div id="advantages">
                ...
                <div class="container">
                    <div class="same-height-row">
                        <div class="col-sm-4">
                            <div class="box same-height clickable"style="background:#4fbfa8;">
                               <img src="img/banner4.jpg" width="100%" style="border: 1px solid gray;" alt="">
                               <h4><a href="#" style="color:black;">100% satisfaction guaranteed</a></h4>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable" style="background:#4fbfa8;">
                                <img src="img/banner8.jpg" width="100%" style="border: 1px solid gray;" alt="">
                                <h4><a href="#" style="color:black;">100% satisfaction guaranteed</a></h4>
                        ...
                        <div class="col-sm-4">
                            <div class="box same-height clickable" style="background:#4fbfa8;">
                                <img src="img/banner9.jpg" width="100%" style="border: 1px solid gray;" alt="">
                                <h4><a href="#" style="color:black;">100% satisfaction guaranteed</a></h4>
                            </div>
                        </div>
                    </div>
